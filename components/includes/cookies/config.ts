...
const updateGoogleTagManager = (categories: string[]) => {
	const consentUpdate: Record<string, "granted" | "denied"> = {
		...
		functionality_storage: categories.includes("necessary")
			? "granted"
			: "denied",
		personalization_storage: categories.includes("marketing")
			? "granted"
			: "denied",
...
export const config: CookieConsentConfig = {
	...
	onFirstConsent: async () => {
		const { step } = useStepZustand.getState()
		const {
			data: { document },
		} = useUserIdentificationZustand.getState()

		sendGTMEvent({
			event: GoogleTagManager.COOKIES_CONSENT,
			data: {
				step,
			},
		})
				...
				preferencesModal: {
					...
					sections: [
						...
						},
						{
							...
							description:
								"Estes cookies são essenciais para o funcionamento adequado do site. Eles não armazenam dados pessoais e não podem ser desativados.",
							linkedCategory: "necessary",
						},
						{
							title: "Cookies de Desempenho e Análise",
							description:
								"Coletam dados anônimos sobre como você utiliza o site. Nos ajudam a melhorar a navegação e entender o tráfego. <b>Ferramentas utilizadas:</b> Google Analytics e Microsoft Clarity.",
								...
								body: [
									{
										...
										description:
											"Usados para distinguir usuários e gerar dados estatísticos.",
									...
									},
									{
										...
										description:
											"Salvam o ID do usuário e dados de sessão para mapas de calor.",
						...
						},
						{
							...
							description:
								"São usados para rastrear visitantes em diferentes sites. A intenção é exibir anúncios relevantes e engajadores para o usuário. <b>Ferramentas utilizadas:</b> Meta Ads, Google Ads, TikTok Ads e LinkedIn Ads.",
								...
								body: [
									{
										...
										description:
											"Usado para rastrear visitas e otimizar anúncios no Facebook/Instagram.",
										expiration: "3 meses",
									},
									{
										name: "_gcl_au",
										domain: "Google Ads",
										description:
											"Usado para testar a eficiência da publicidade em nossos sites.",
										expiration: "3 meses",
									},
									{
										...
										domain: "TikTok Ads",
										description:
											"Mede o desempenho de campanhas publicitárias do TikTok.",
										expiration: "1 ano",
									},
								],
							},
