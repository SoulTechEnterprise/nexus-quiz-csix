...
export function AuthorizationLoanLink() {
    ...
    const handleForm = async ({ phone }: ZodSchema) => {
        ...
        send_message_to_whatsapp({ name: getUserIdentification.name, phone, link: "https://google.com" })
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Receba o link de autorização no seu Whatsapp.</CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <CardFooter>
                <Button type="submit" form={_FORM}>Enviar link</Button>
            </CardFooter>
        </Card>
    )
}
